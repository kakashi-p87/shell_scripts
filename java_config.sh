...
echo "#		       JAVA_HOME     	#";
echo "###################################################";
sudo -i chown -R root:${USER} /etc/enviroment;
sudo -i chmod -R ug+w /etc/enviroment;
sudo -i echo "JAVA_HOME='${java_directory}${jdk_directory}'" >> /etc/enviroment;
sudo -i source /etc/enviroment;
echo $JAVA_HOME;
